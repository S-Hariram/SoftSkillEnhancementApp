document.addEventListener('DOMContentLoaded', function() {
    ...
    const request = indexedDB.open("VocabularyLessonsDB", 1);
    ...
    function getLessons(callback) {
        ...
        request.onsuccess = function(event) {
            console.log('Lessons retrieved:', request.result); // Log retrieved lessons
    ...
    function displayFilteredLessons() {
        ...
        getLessons(function(lessonList) {
            lessons = lessonList;
            console.log('Filtered lessons:', lessons); // Log filtered lessons
    ...
    function markLessonComplete() {
        ...
        request.onsuccess = function(event) {
            const lesson = event.target.result;
            if (lesson) {
                lesson.completed = true; // Add a 'completed' flag or update status
